...
-- Database: `electro`
--
CREATE DATABASE IF NOT EXISTS `electro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `electro`;
...
--
ALTER TABLE `laptop`
  MODIFY `lp_id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `led`
--
ALTER TABLE `led`
  MODIFY `l_id` int(2) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `registration`
  MODIFY `r_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"electro\",\"table\":\"registration\"},{\"db\":\"electro\",\"table\":\"phone\"},{\"db\":\"electro\",\"table\":\"category\"},{\"db\":\"electro\",\"table\":\"laptop\"},{\"db\":\"electro\",\"table\":\"led\"}]');
...
('root', '2023-09-17 11:04:40', '{\"Console\\/Mode\":\"collapse\"}');
