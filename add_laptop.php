...
// $target_file=$target_dir . basename($_FILES["image"] ["name"]) ; //which file upload from form and where
// //echo "$target_file";
...
// {
//     $img=$target_file;
//     $sql="INSERT INTO laptop VALUES ('$name','$model',$price,'$img')";
...
$sql = "INSERT INTO laptop (name, model, price,desc)
VALUES ('$name','$model',$price,'$desc')";
